...
public:
    ...
    void create_account(int);     // get data from user
    ...
    void fgrecolor_blue(){
        ...
        // Set the background color to normal and the text color to glowing blue
        SetConsoleTextAttribute(hConsole, FOREGROUND_GREEN | FOREGROUND_BLUE);
    }
    void fgrecolor_green(){
        
        // Set the background color to normal and the text color to green
        SetConsoleTextAttribute(hConsole, FOREGROUND_GREEN);
    }
    void fgrecolor_rblue(){
        
        // Set the background color to normal and the text color to purple
        SetConsoleTextAttribute(hConsole, FOREGROUND_RED| FOREGROUND_BLUE);
    }
    void fgrecolor_yellow(){
        
        // Set the background color to normal and the text color to yellow
        SetConsoleTextAttribute(hConsole, FOREGROUND_RED| FOREGROUND_GREEN);
    }
};                              

void account::create_account(int acn)
{
	fgrecolor_green();
	acno = acn;
...
class cc{
	...
	void step_three(){	        
    	...
    	if(doubleEvenSum % 10 == 0){
    		recolor_green();
    		cout<<" The given credit card number is valid! "; 
    		recolor_normal();
			cout<<"\n";
		}
    	else{
    		recolor_red();
    		cout<<" The given credit card number is Invalid! "; 
    		recolor_normal();
			cout<<"\n";
		}
    	line();
	...
	void recolor_red(){ 
	    ...
	    // Set the console background color to Red and the text color to white
	    SetConsoleTextAttribute(hConsole, BACKGROUND_RED | FOREGROUND_BLUE | FOREGROUND_GREEN | FOREGROUND_RED);
	}
	void recolor_green(){ 
	
	    // Set the console background color to Green and the text color to white
	    SetConsoleTextAttribute(hConsole, BACKGROUND_GREEN | FOREGROUND_BLUE | FOREGROUND_GREEN | FOREGROUND_RED);
	}
	void recolor_normal(){
		
		// Set the console background color to normal and the text color to white
		SetConsoleTextAttribute(hConsole, FOREGROUND_BLUE | FOREGROUND_GREEN | FOREGROUND_RED);
	}
	void recolor_blue(){
		
		// Set the console background color to blue and the text color to white
	    SetConsoleTextAttribute(hConsole, FOREGROUND_GREEN | FOREGROUND_BLUE);
	}
};
ccvalidator(){ 
...
int main()
{
    ...
    do
    {
        ...
        case '5':
			...
			while ((cha = _getch()) != '\r') { // read characters until Enter key is pressed
			    if (cha == '\b') { // handle backspace
			    	if (!password.empty()) {
			        	password.erase(password.end() - 1); // erase last character from string
			        	cout << "\b \b"; // erase character from screen
			      }
			    } else {
			      password += cha;
			      cout << "*"; // print asterisk to screen
			    }
			}
        	if(password == "kada" && aid == "bank"){
        		system("cls");
	 			display_all();
			}
			else{
